...
export class CulturalesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.publicaciones = this.publicacionesService.getAll('culturales');
  ...
  crearPublicacion(): void {
    if (this.publicacionEditando) {
      ...
      this.publicacionesService.crear('culturales', {
        ...this.form.value,
        autor,
        sede
      });
  ...
  reportarPublicacion(pub: Publicacion): void {
    this.reportesService.reportarPublicacion('culturales', pub);
  }
