...
export class DetalleVoluntariadoComponent implements OnInit {
  ...
  reportarPublicacion(): void {
    if (this.publicacion) {
      this.reportesService.reportarPublicacion('voluntariado', this.publicacion);
    }
  }

  reportarComentario(comentario: Comentario): void {
    if (this.publicacion) {
      this.reportesService.reportarComentario('voluntariado', this.publicacion.id, comentario);
    }
  }
