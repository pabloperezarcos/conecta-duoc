...
export class TruequesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.publicaciones = this.publicacionesService.getAll('trueques');
  ...
  crearPublicacion(): void {
    if (this.publicacionEditando) {
      ...
      this.publicacionesService.crear('trueques', {
        ...this.form.value,
        autor,
        sede
      });
  ...
  reportarPublicacion(pub: Publicacion): void {
    this.reportesService.reportarPublicacion('trueques', pub);
  }
