...
describe('PostCategoryService', () => {
  ...
  it('should fetch all categories', () => {
    ...
    const req = httpMock.expectOne('https://8d20h7wiag.execute-api.us-east-2.amazonaws.com/api/post-category');
  ...
  it('should update an existing category', () => {
    ...
    const req = httpMock.expectOne('https://8d20h7wiag.execute-api.us-east-2.amazonaws.com/api/post-category/1');
