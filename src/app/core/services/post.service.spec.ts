...
describe('PostService', () => {
  ...
  it('should fetch all posts', () => {
    ...
    const req = httpMock.expectOne('https://8d20h7wiag.execute-api.us-east-2.amazonaws.com/api/post');
  ...
  it('should fetch posts by category ID', () => {
    ...
    const req = httpMock.expectOne('https://8d20h7wiag.execute-api.us-east-2.amazonaws.com/api/post?idCategory=1');
    expect(req.request.method).toBe('GET');
    req.flush(dummyPosts);
  });
  ...
  it('should fetch a post by ID', () => {
    ...
    const req = httpMock.expectOne('https://8d20h7wiag.execute-api.us-east-2.amazonaws.com/api/post/1');
    expect(req.request.method).toBe('GET');
    req.flush(dummyPost);
  });
  ...
  it('should register a view for a post', () => {
    ...
    const req = httpMock.expectOne('https://8d20h7wiag.execute-api.us-east-2.amazonaws.com/api/post/1/view');
