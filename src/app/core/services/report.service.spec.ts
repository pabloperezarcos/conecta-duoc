...
describe('ReportService', () => {
  ...
  it('should report a post', () => {
    ...
    const req = httpMock.expectOne('http://localhost:9090/api/report/publicacion');
  ...
  it('should report a comment', () => {
    ...
    const req = httpMock.expectOne('http://localhost:9090/api/report/comentario');
    expect(req.request.method).toBe('POST');
    req.flush(dummyReport);
  });
  ...
  it('should get all reports', () => {
    ...
    const req = httpMock.expectOne('http://localhost:9090/api/report');
  ...
  it('should update report status', () => {
    ...
    const req = httpMock.expectOne('http://localhost:9090/api/report/1');
