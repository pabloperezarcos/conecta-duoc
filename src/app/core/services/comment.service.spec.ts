...
describe('CommentService', () => {
  ...
  it('should fetch comments by post ID', () => {
    ...
    const req = httpMock.expectOne('https://8d20h7wiag.execute-api.us-east-2.amazonaws.com/api/comment/post/1');
  ...
  it('should create a new comment', () => {
    ...
    const req = httpMock.expectOne('https://8d20h7wiag.execute-api.us-east-2.amazonaws.com/api/comment');
  ...
  it('should delete a comment', () => {
    ...
    const req = httpMock.expectOne('https://8d20h7wiag.execute-api.us-east-2.amazonaws.com/api/comment/1');
