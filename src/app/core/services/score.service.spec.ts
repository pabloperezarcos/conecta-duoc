...
describe('ScoreService', () => {
    ...
    it('should fetch average score', () => {
        ...
        const req = httpMock.expectOne('https://8d20h7wiag.execute-api.us-east-2.amazonaws.com/api/score/average/1');
    ...
    it('should fetch user score', () => {
        ...
        const req = httpMock.expectOne('https://8d20h7wiag.execute-api.us-east-2.amazonaws.com/api/score/user/1/post/1');
        expect(req.request.method).toBe('GET');
    ...
    it('should save user score', () => {
        ...
        const req = httpMock.expectOne('https://8d20h7wiag.execute-api.us-east-2.amazonaws.com/api/score/save');
    ...
    it('should fetch resumen scores', () => {
        ...
        const req = httpMock.expectOne('https://8d20h7wiag.execute-api.us-east-2.amazonaws.com/api/score/resumen?idUser=1');
        expect(req.request.method).toBe('GET');
    ...
    it('should fetch resumen scores with category', () => {
        ...
        const req = httpMock.expectOne('https://8d20h7wiag.execute-api.us-east-2.amazonaws.com/api/score/resumen?idUser=1&idCategoria=2');
        expect(req.request.method).toBe('GET');
        req.flush(dummyResumen);
    });
});